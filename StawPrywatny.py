...
class StawPrywatny:
    ...
    def __init__(self, _nazwa, _jakoscWody, _liczbaRyb, _liczbaStanowisk, _ryby, _wlasciciel):
        self.nazwa = _nazwa
    ...
    def zajmijStanowisko(self):
        if int(self.liczbaWolnychStanowisk) > 0:
            ...
            print("Na stawie prywatnym "+ self.nazwa  + " zabrakło miejsca")
            return 0
    ...
    def sprobujZlapac(self, wedka):
        if self.jakoscWody < 6 :
            ...
            print("W stawie prywatnym  " + self.nazwa + " nie ma już ryb.")
        return 0
